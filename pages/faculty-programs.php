...
<body>
    ...
    <div class="fixed top-4 left-4 z-50 ">
        <button onclick="toggleSidebar()" class="bg-[#10375B] text-white p-2 rounded focus:outline-none hover:cursor-pointer">
            ☰
        </button>
    </div>

    <!-- Sidebar -->
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-[#10375B] text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 z-40 p-4" aria-label="sidebar">
        <!-- Logo -->
        <div class="flex items-center justify-center">
            <img src="../images/Al-ghaya logoForPrint.svg" alt="Logo" class="w-15 h-15">
        </div>

        <!-- User Info -->
        <div class="text-center mt-6">
            <div class="text-lg font-semibold">John Doe</div>
            <div class="text-sm text-gray-300">Ustadh</div>
        </div>

        <!-- Navigation -->
        <nav class="flex flex-col space-y-2 mt-6">
            <a href="dashboard.php" class="flex items-center space-x-3 hover:bg-[#0e2f4b] px-3 py-2 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6" />
                </svg>
                <span>Dashboard</span>
            </a>
            <a href="programs.php" class="flex items-center space-x-3 hover:bg-[#0e2f4b] px-3 py-2 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" />
                </svg>
                <span>Programs</span>
            </a>
            <a href="analytics.php" class="flex items-center space-x-3 hover:bg-[#0e2f4b] px-3 py-2 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path d="M11 19V6M6 13l5-7 5 7M4 19h16" />
                </svg>
                <span>Analytics</span>
            </a>
            <a href="settings.php" class="flex items-center space-x-3 hover:bg-[#0e2f4b] px-3 py-2 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    <path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42M12 8a4 4 0 100 8 4 4 0 000-8z" />
                </svg>
                <span>Settings</span>
            </a>
        </nav>
    ...
    <main>
            ...
            <div class="mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div id="mobile-menu" class="hidden flex flex-col items-center overflow-hidden max-h-0 transition-all duration-900 ease-in-out">
                    <div class="px-2 pt-2 pb-3 space-y-2 flex flex-col items-center w-full">
                        ...
                        <a href="faculty.php" class="block w-full text-center rounded-md px-3 py-2 text-sm font-medium text-neutral-800 hover:bg-gray-700 hover:text-white bg-gray-700 text-white">Faculty</a>
        ...
        <section class="mt-15">
            <p class="text-3xl text-[#10375B] font-bold mb-10 text-center">My Programs</p>
            <!-- Create Program Trigger -->
            <div class="container flex flex-row gap-5 items-center px-4 mx-auto mb-15">
        ...
        <section class="mb-15 mt-15">
            <p class="text-3xl text-[#10375B] font-bold mb-10 text-center">Al-Ghaya's Programs</p>
            <!-- Beginner -->
